        ...
        <Document>
            <Page size="A4" style={styles.page} wrap={true}>
                ...
                <View style={styles.quoteInfo}>
                    <Text style={styles.quoteInfo.date}>Date: {DateTime.local().toFormat("y/MM/dd")}</Text>
                    <Text style={{paddingBottom: "2px"}}>Quote Reference: {props.invoiceNumber}</Text>
                    <Text style={{paddingBottom: "2px"}}>Project: {props.projectName}</Text>
                    <Text
                        style={{paddingBottom: "2px"}}>Address: {props.client.streetName} {props.client.town} {props.client.postcode.toUpperCase()}</Text>
                ...
                <View style={styles.main}>
                    ...
                    <Text style={{fontSize: "10px", fontWeight: 900}}>Proposed contract price ex VAT:
                        £{getTotalPrice()}</Text>
